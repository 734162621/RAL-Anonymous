...
def tpysc2_move_camera(action, action_space, world):
  """Move the camera."""
  action_cmd = action.action_raw.camera_move
  world.assign_to(action_cmd.center_world_space)
...
FUNCTION_TYPES = {
    ...
    tpysc2_move_camera: [RAW_TYPES.world],
}
...
_FUNCTIONS = [
    ...
    Function.ui_func(573, "tpysc2_move_camera", tpysc2_move_camera),
...
# print(FUNCTIONS._func_dict)
# print(FUNCTIONS._func_dict['no_op'])
