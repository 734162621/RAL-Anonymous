...
def analyse_dir(path, start_time: int, end_time=0, delete_unfinished=False):
  num_experiments = 0
  ...
  if os.path.isdir(path):
    ...
    log_folder_names = os.listdir(path)
...
end_time   = 20500000000000
result = analyse_dir("", start_time, end_time)
